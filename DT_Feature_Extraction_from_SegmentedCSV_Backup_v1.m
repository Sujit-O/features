...
for channel_i = 1:1%size(totalChannelFolders,1)
    ...
    for segmentFolder_i=1:1%size(segmentChannelFolders,1)
        ...
        for segment_i=1:1%size(segmentFiles,1)
            ...
            extractFeatures (fileNameFull,labelNameFull, ...
                data,'time',fs,Time_win, Time_step,Time_numLags,...
...
function []=extractFeatures (fileNameFull,labelNameFull, data,...
    featureName,fs,Time_win, Time_step,Time_numLags,Time_orders,...
        Time_bins,Time_peakNumber,Time_peakNumberEnvelop,...
        Time_peakNumberGradient)

if strcmp(featureName,'time')
