function frequencyFeatures = F_Frequency_Feature_STFTStatistics(signal, fs, win, step, FFTPeakNumber )
...
[featureNames,...
    numberOfFeatures,...
    numberofFFTPeakFeatures] = G_FeatureExtraction_Frequency_STFTStastistics_FeatureNames(FFTPeakNumber);
