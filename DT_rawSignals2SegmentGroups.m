...
channelNames={'Mic_1';'Mic_2';'Mic_3';...
    'Mic_4';'Current';'Vib_x2';...
    'Vib_y2';'Vib_z2';'Vib_x1';...
    'Vib_y1';'Vib_z1';...
    'Vib_x0';...
    'Vib_y0';'Vib_z0';...
...
%     synchFileDaQTime=csvread(synchDaQFileName,1,0);
    synchFileDaQTime=csvread(synchDaQFileName);
    hourOffset=synchFileRealTime-synchFileDaQTime(1);
    
    %%
    %for each data Folder read the corresponding Channels
    for dataFolder_i=1:size(totalCSVDataFolders,1)
...
%         daqStartTime= csvread(metaDataFileName,1,0);
        daqStartTime= csvread(metaDataFileName);
        ...
        for channel_i=1:size(channelNames,1)
            ...
            for seg_i=1:size(segTime,2)
                ...
                for segNumber_i=1:segTime(seg_i).subSegmentsNumber
                    ...
                    index=[];
                    parfor times_i=1:size(segTime(seg_i).subSegments(segNumber_i).startTime,1)
